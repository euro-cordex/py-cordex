...
def domain(short_name, nlon, nlat, dlon, dlat, ll_lon, ll_lat, 
        pollon, pollat, dummy=None,  **kwargs):
...
def rotated_coord_transform(lon, lat, np_lon, np_lat,
    ...
    #lon_new = np.atan2(y_new, x_new)
    #lat_new =rc np.asin(z_new)
